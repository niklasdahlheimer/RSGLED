...
static CRGBSet g1 = CRGBSet(leds, LED_GROUP_START_INDEX_1, LED_GROUP_START_INDEX_1 + LED_GROUP_NUM_PER_GROUP - 1);
static CRGBSet g2 = CRGBSet(leds, LED_GROUP_START_INDEX_2, LED_GROUP_START_INDEX_2 + LED_GROUP_NUM_PER_GROUP - 1);
static CRGBSet g3 = CRGBSet(leds, LED_GROUP_START_INDEX_3, LED_GROUP_START_INDEX_3 + LED_GROUP_NUM_PER_GROUP - 1);
static CRGBSet g4 = CRGBSet(leds, LED_GROUP_START_INDEX_4, LED_GROUP_START_INDEX_4 + LED_GROUP_NUM_PER_GROUP - 1);
static CRGBSet g5 = CRGBSet(leds, LED_GROUP_START_INDEX_5, LED_GROUP_START_INDEX_5 + LED_GROUP_NUM_PER_GROUP - 1);
static CRGBSet g6 = CRGBSet(leds, LED_GROUP_START_INDEX_6, LED_GROUP_START_INDEX_6 + LED_GROUP_NUM_PER_GROUP - 1);
static CRGBSet g7 = CRGBSet(leds, LED_GROUP_START_INDEX_7, LED_GROUP_START_INDEX_7 + LED_GROUP_NUM_PER_GROUP - 1);
static CRGBSet g8 = CRGBSet(leds, LED_GROUP_START_INDEX_8, LED_GROUP_START_INDEX_8 + LED_GROUP_NUM_PER_GROUP - 1);
static CRGBSet g9 = CRGBSet(leds, LED_GROUP_START_INDEX_9, LED_GROUP_START_INDEX_9 + LED_GROUP_NUM_PER_GROUP - 1);
static CRGBSet g10 = CRGBSet(leds, LED_GROUP_START_INDEX_10,LED_GROUP_START_INDEX_10 + LED_GROUP_NUM_PER_GROUP - 1);
static CRGBSet groupAll = CRGBSet(leds, LED_GROUP_START_INDEX_1, LED_NUM - 1);
