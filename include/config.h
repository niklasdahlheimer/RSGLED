    ...
    switch (index) {
        ...
        default:
            return (Config) {
                    ...
                    .lines = {
                            {1,  107, 108, 212, 213, 314, 315, 418, 419, 420, 429, 430}, //1
                            {2,  106, 109, 211, 214, 313, 316, 417, 421, 428, 431}, //2
                            {3,  105, 110, 210, 215, 312, 317, 416, 422, 427, 432}, //3
                            {4,  104, 111, 209, 216, 311, 318, 415, 423, 424, 425, 426, 433}, //4
                            {5,  103, 112, 208, 217, 310, 319, 414, 436}, //5
                            {6,  102, 113, 207, 218, 309, 320, 413, 437}, //6
                            {7,  101, 114, 206, 219, 308, 321, 412, 438}, //7
                            {8,  100, 115, 205, 220, 307, 322, 411, 439}, //8
                            {9,  99,  116, 204, 221, 306, 323, 410, 440, 452}, //9
                            {10, 98,  117, 203, 222, 305, 324, 409, 441, 451}, //10
                            {11, 97,  118, 202, 223, 304, 325, 408, 442, 450}, //11
                            {12, 96,  119, 201, 224, 303, 326, 407, 443, 449}, //12
                            {13, 95,  120, 200, 225, 302, 327, 406}, //13
                            {14, 94,  121, 199, 226, 301, 328, 405}, //14
                            {15, 93,  122, 198, 227, 300, 329, 404}, //15
                            {16, 92,  123, 197, 228, 299, 330, 403}, //16
                            {17, 91,  124, 196, 229, 298, 331, 402}, //17
                            {18, 90,  125, 195, 230, 297, 332, 401}, //18
                            {19, 89,  126, 194, 231, 296, 333, 400}, //19
                            {20, 88,  127, 193, 232, 295, 334, 399}, //20
                            {21, 87,  128, 192, 233, 294, 335, 398}, //21
                            {22, 86,  129, 191, 234, 293, 336, 397}, //22
                            {23, 85,  130, 190, 235, 292, 337, 396}, //23
                            {24, 84,  131, 189, 236, 291, 338, 395}, //24
                            {25, 83,  132, 188, 237, 290, 339, 394}, //25
                            {26, 82,  133, 187, 238, 289, 340, 393}, //26
                            {27, 81,  134, 186, 239, 288, 341, 392}, //27
                            {28, 80,  135, 185, 240, 287, 342, 391}, //28
                            {29, 79,  136, 184, 241, 286, 343, 390}, //29
                            {30, 78,  137, 183, 242, 285, 344, 389}, //30
                            {31, 77,  138, 182, 243, 284, 345, 388}, //31
                            {32, 76,  139, 181, 244, 283, 346, 388}, //32 !!!!!!
                            ...
                            {39, 69,  146, 174, 251, 276, 353, 380}, //39 AB HIER WIEDER
                            {40, 68,  147, 173, 252, 275, 354, 379}, //40
                            {41, 67,  148, 172, 253, 274, 355, 378}, //41
                            {42, 66,  149, 171, 254, 273, 356, 377}, //42
                            {43, 65,  150, 170, 255, 272, 357, 376}, //43
                            {44, 64,  151, 169, 256, 271, 358, 375}, //44
                            {45, 63,  152, 168, 257, 270, 359, 374}, //45
                            {46, 62,  153, 167, 258, 269, 360, 373}, //46
                            {47, 61,  154, 166, 259, 268, 361, 372}, //47
                            {48, 60,  155, 165, 260, 267, 362, 371}, //48
                            {49, 59,  156, 164, 261, 266, 363, 370}, //49
                            {50, 58,  157, 163, 262, 265, 364, 369}, //50
                            {51, 57,  158, 162, 263, 264, 365, 368}, //51
                            {52, 56,  159, 161, 264, 263, 366, 367}, //52
                            {53, 55,  160, 160, 265, 262, 367, 366}, //53
                            {54, 54,  161, 159, 266, 261, 368, 365}, //54
                    },
                    .groups = {
                            {}, // 0 default all group
                            {1,  2,  3,  4}, // 1
